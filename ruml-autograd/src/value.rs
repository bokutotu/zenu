...
// impl Value for f64 {}
//
// impl<T: Num, O: OwnedMemory<Item = T>, D: DimTrait> Zero for Matrix<O, D> {
//     fn zero(dim: &[usize]) -> Self {
//         Zeros::zeros(dim)
//     }
// }
//
// impl<T: Num, O: OwnedMemory<Item = T>, D: DimTrait> One for Matrix<O, D> {
//     fn one(dim: &[usize]) -> Self {
//         Ones::ones(dim)
//     }
// }
//
// impl<T: Num, O: OwnedMemory<Item = T>, D: DimTrait> Value for Matrix<O, D> {}
//
// // #[derive(Clone)]
// // pub enum Val {
// //     F64(f64),
